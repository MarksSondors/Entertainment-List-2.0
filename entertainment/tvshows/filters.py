"""FilterSet for the TV Shows explorer endpoint."""
...
class TVShowFilter(UserContextFilterMixin):
    _content_type_model = TVShow
    ...
    year_min = django_filters.NumberFilter(field_name="first_air_date__year", lookup_expr="gte")
    year_max = django_filters.NumberFilter(field_name="first_air_date__year", lookup_expr="lte")
